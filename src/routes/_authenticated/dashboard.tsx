      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex gap-1 overflow-x-auto pb-1">
            {(["today", "week", "month", "last_month", "quarter", "year", "all"] as Period[]).map((p) => (
              <button key={p} onClick={() => { setMode("period"); setPeriod(p); }}
                ...
                {p === "today" ? "Hoy" : p === "week" ? "Semana" : p === "month" ? "Mes" : p === "last_month" ? "Mes pasado" : p === "quarter" ? "Trimestre" : p === "year" ? "Año" : "Todo"}
              </button>
            ))}
